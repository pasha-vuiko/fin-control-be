...
END $$;
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "Customer_email_key" ON "Customer" (email text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "Customer_phone_key" ON "Customer" (phone text_ops);--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "Customer_userId_key" ON "Customer" ("userId" text_ops);
